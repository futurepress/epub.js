...
import {
  ...
  Underline,
  Waveline,
} from "../helpers/marks-pane/src/marks.js";
  ...
  underline(cfiRange, data = {}, cb, className = "epubjs-ul", styles = {}) {
    ...
    if (!this.pane) {
      this.pane = new Pane(this.iframe, this.element);
		...
		let h,m;
    // judge is wave
    if (styles.lineType === "wave") {
      m = new Waveline(range, className, data, attributes);
    } else {
      m = new Underline(range, className, data, attributes);
    }
